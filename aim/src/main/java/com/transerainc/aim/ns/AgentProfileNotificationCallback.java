 ...
 * @version $Rivision:$
 */
public class AgentProfileNotificationCallback implements NotificationCallback {
	private static Logger lgr = Logger
			.getLogger(AgentProfileNotificationCallback.class.getName());
	...
	public void entityChanged(NotificationServerMessage message) {
		if (lgr.isLoggable(Level.INFO)) {
			lgr.info("Got a Agent Profiles changed/added/removed event.");
		}
		...
		ACGNotificatonDelegator delegator = new ACGNotificatonDelegator(
				AgentProfileNotificationCallback.class.getName());
