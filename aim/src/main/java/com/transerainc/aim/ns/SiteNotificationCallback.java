 ...
 * @version $Rivision:$
 */
public class SiteNotificationCallback implements NotificationCallback {
	private static Logger lgr = Logger.getLogger(SiteNotificationCallback.class
			.getName());
	...
	public void entityChanged(NotificationServerMessage message) {
		if (lgr.isLoggable(Level.INFO)) {
			lgr.info("Got a Site changed/added/removed event.");
		}
		...
		ACGNotificatonDelegator delegator = new ACGNotificatonDelegator(
				SiteNotificationCallback.class.getName());
