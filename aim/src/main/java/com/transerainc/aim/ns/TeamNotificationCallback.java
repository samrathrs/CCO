 ...
 * @version $Rivision:$
 */
public class TeamNotificationCallback implements NotificationCallback {
	private static Logger lgr = Logger.getLogger(TeamNotificationCallback.class
			.getName());
	...
	public void entityChanged(NotificationServerMessage message) {
		...
		ACGNotificatonDelegator delegator = new ACGNotificatonDelegator(
				TeamNotificationCallback.class.getName());
